let localize,localizeCountry;_0eb‍.w("../translations/translate.js",[["localize",["localize"],function(v){localize=v}],["localizeCountry",["localizeCountry"],function(v){localizeCountry=v}]]);// require("dotenv").config()
...
bot.on('message', message => {
    ...
    args.shift()
    _0eb‍.g.console.log("Command: "+args.join(" "))
    if (!args.length) getall(message)
        ...
        if (isSwear) {
            swearCounter++;
            _0eb‍.g.console.log(Swear + " deleted")
            // message.delete()
